...
exports.QvahubLocalhost = void 0;
...
let QvahubLocalhost = (() => {
    ...
    let _classThis;
    var QvahubLocalhost = _classThis = class {
        constructor() {
            this.IPv4 = '127.0.0.1';
            this.port = 52330;
        }
        setPortNumberFromLocation() {
            ...
            if (this.port === 52400)
                this.port = 52330; //this allows usage of ng cli in dev mode on port 52400
            if (this.port === 52401)
                this.port = 52330; //this allows usage of ng cli in dev mode on port 52400
        }
        setIPv4FromLocation() {
    ...
    __setFunctionName(_classThis, "QvahubLocalhost");
    (() => {
        const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        QvahubLocalhost = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return QvahubLocalhost = _classThis;
})();
exports.QvahubLocalhost = QvahubLocalhost;
